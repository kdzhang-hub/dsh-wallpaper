...
export function wallpaperHarnessTool(engine) {
  return defineTool({
    ...
    description: 'Control the DeepSeek Harness interface background using the Wallpaper Engine library. ' +
      ...
      'motionMode=play or static, and paletteMode=auto or manual with accentColor/secondaryAccentColor=#RRGGBB. ' +
    ...
    parameters: {
      ...
      motionMode: { type: 'string', enum: ['play', 'static'], description: 'play animates GIF/video in Harness; static freezes its Harness preview only.' },
