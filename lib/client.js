...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = [
      ...
      '[data-dsh-wallpaper-backdrop] > [data-wp-loading] { opacity: 0 !important; }',
      '[data-dsh-wallpaper-backdrop][data-wp-low-quality] > img:not([data-wp-ambient]) { image-rendering: auto; backface-visibility: hidden; filter: brightness(var(--wp-brightness,1)) saturate(var(--wp-detail-saturation,1.04)) contrast(var(--wp-detail-contrast,1.05)) drop-shadow(0 0 26px rgba(0,0,0,.24)); }',
      '[data-dsh-wallpaper-backdrop] > [data-wp-hidden] { display: none; }',
      '.wp-backdropBloom { position: absolute; inset: -16vmax; z-index: 3; pointer-events: none; opacity: .92; filter: blur(2px); }',
      '[data-wp-bloom="primary"] { background: radial-gradient(circle at 14% 22%, var(--wp-bloom-primary,rgba(79,140,255,.34)) 0, transparent 30%), radial-gradient(circle at 78% 70%, var(--wp-bloom-secondary,rgba(98,199,165,.25)) 0, transparent 38%); }',
      '[data-wp-bloom="secondary"] { background: radial-gradient(circle at 82% 16%, var(--wp-bloom-secondary,rgba(98,199,165,.20)) 0, transparent 26%), radial-gradient(circle at 44% 94%, var(--wp-bloom-primary,rgba(79,140,255,.22)) 0, transparent 34%); opacity: .65; transform: scale(1.06); }',
      '[data-dsh-wallpaper-backdrop][data-wp-motion="play"] [data-wp-bloom="primary"] { animation: wpAmbientDrift 18s ease-in-out infinite alternate; }',
      '[data-dsh-wallpaper-backdrop][data-wp-motion="play"] [data-wp-bloom="secondary"] { animation: wpAmbientDrift 23s ease-in-out -8s infinite alternate-reverse; }',
      '@keyframes wpAmbientDrift { from { transform: translate3d(-1.5%, -1%, 0) scale(1); } to { transform: translate3d(2%, 1.5%, 0) scale(1.08); } }',
      '.wp-backdropScrim { position: absolute; inset: 0; z-index: 4; background: linear-gradient(124deg, rgba(3,8,18,.38), transparent 48%, rgba(3,8,18,.26)), rgba(8, 12, 26, var(--wp-harness-scrim, .35)); }',
      ...
      'html body[data-dsh-wallpaper-skin] [data-pane="sidebar"] { background: linear-gradient(180deg, var(--wp-sidebar), var(--wp-bg-layer-2)) !important; box-shadow: inset -1px 0 0 var(--wp-border-soft), inset 0 1px 0 rgba(255,255,255,.15); }',
      'html body[data-dsh-wallpaper-skin] [data-pane="conversation"], html body[data-dsh-wallpaper-skin] [data-pane="details"], html body[data-dsh-wallpaper-skin] [data-shell-overlay] > * { background: linear-gradient(155deg, var(--wp-bg-layer-1), var(--wp-bg-base)) !important; }',
      'html body[data-dsh-wallpaper-skin] [data-pane="conversation"]:has([data-composer-seat]) { background: linear-gradient(160deg, var(--wp-home-surface), var(--wp-bg-base) 66%, var(--wp-bg-layer-1)) !important; box-shadow: inset 0 1px 0 rgba(255,255,255,.15), inset 0 0 0 1px rgba(255,255,255,.035); }',
      /* The Composer keeps its original controls; only its outer surface gets
       * a subtle, wallpaper-coloured glass frame. Inset shadows avoid a
       * layout shift while the user is typing. */
      'html body[data-dsh-wallpaper-skin] [data-composer-seat] > * { background: linear-gradient(135deg, rgba(255,255,255,.10), var(--wp-input)) !important; border-radius: 18px; box-shadow: inset 0 1px 0 rgba(255,255,255,.24), inset 0 0 0 1px var(--wp-border-soft), 0 18px 46px rgba(0,0,0,.30), 0 0 36px var(--wp-composer-glow); transition: box-shadow 180ms ease, background-color 180ms ease, transform 180ms ease; }',
      'html body[data-dsh-wallpaper-skin] [data-composer-seat]:focus-within > * { box-shadow: inset 0 1px 0 rgba(255,255,255,.32), inset 0 0 0 1px var(--wp-border-strong), 0 0 0 3px var(--wp-accent-wash-soft), 0 22px 52px rgba(0,0,0,.34), 0 0 44px var(--wp-composer-glow-strong); transform: translateY(-1px); }',
      ...
      /* Keep the Composer's stronger glass ring after the shared pane rule. */
      'html body[data-dsh-wallpaper-skin] [data-composer-seat] > * { box-shadow: inset 0 1px 0 rgba(255,255,255,.24), inset 0 0 0 1px var(--wp-border-soft), 0 18px 46px rgba(0,0,0,.30), 0 0 36px var(--wp-composer-glow); }',
      'html body[data-dsh-wallpaper-skin] [data-composer-seat]:focus-within > * { box-shadow: inset 0 1px 0 rgba(255,255,255,.32), inset 0 0 0 1px var(--wp-border-strong), 0 0 0 3px var(--wp-accent-wash-soft), 0 22px 52px rgba(0,0,0,.34), 0 0 44px var(--wp-composer-glow-strong); }',
      'html body[data-dsh-wallpaper-skin] [data-dsh-wallpaper-surface] { background: var(--wp-bg-layer-1) !important; backdrop-filter: blur(var(--wp-blur,8px)) saturate(1.20) contrast(1.03) !important; -webkit-backdrop-filter: blur(var(--wp-blur,8px)) saturate(1.20) contrast(1.03) !important; }',
      /* AionUI owns the right-side Explorer/Preview grid. Its source exposes
       * these data attributes as a public mounting contract; do not use its
       * CSS-module class names here. Global tokens keep menus/drag handles
       * legible, while the two docked columns use translucent glass. */
      'html body[data-dsh-wallpaper-skin] { --aion-bg-base:var(--wp-overlay); --aion-bg-1:var(--wp-overlay); --aion-bg-2:var(--wp-bg-layer-3); --aion-bg-3:var(--wp-border-soft); --aion-bg-hover:var(--wp-accent-wash-soft); --aion-bg-active:var(--wp-accent-wash); --aion-text-primary:var(--wp-fg-primary); --aion-text-secondary:var(--wp-fg-secondary); --aion-text-tertiary:var(--wp-fg-tertiary); --aion-text-disabled:var(--wp-fg-dimmed); --aion-primary:var(--wp-accent); --aion-brand:var(--wp-accent-secondary); --aion-success:rgb(118,222,168); --aion-warning:rgb(255,202,112); --aion-danger:rgb(255,144,154); --aion-aou-1:var(--wp-accent-wash-soft); --aion-aou-2:var(--wp-accent-wash); --aion-aou-3:var(--wp-border-soft); --aion-aou-4:var(--wp-border-strong); --aion-aou-5:var(--wp-accent-secondary); --aion-aou-6:var(--wp-accent); --aion-fill-2:var(--wp-accent-wash-soft); --aion-fill-3:var(--wp-accent-wash); --aion-border-base:var(--wp-border-soft); --aion-overlay-shadow:0 18px 48px rgba(0,0,0,.48); }',
      'html body[data-dsh-wallpaper-skin] :is([data-aionui-explorer-col],[data-aionui-preview-col]) { --aion-bg-base:var(--wp-bg-layer-2); --aion-bg-1:var(--wp-bg-layer-2); --aion-bg-2:var(--wp-bg-layer-3); --aion-bg-3:var(--wp-border-soft); --aion-bg-hover:var(--wp-accent-wash-soft); --aion-bg-active:var(--wp-accent-wash); --aion-fill-2:var(--wp-accent-wash-soft); --aion-fill-3:var(--wp-accent-wash); background:var(--wp-bg-layer-2) !important; border-left-color:var(--wp-border-soft) !important; color:var(--wp-fg-primary); backdrop-filter:blur(var(--wp-blur,8px)) saturate(1.20) contrast(1.03); -webkit-backdrop-filter:blur(var(--wp-blur,8px)) saturate(1.20) contrast(1.03); box-shadow:inset 1px 0 0 rgba(255,255,255,.12); }',
      'html body[data-dsh-wallpaper-skin] :is([data-aionui-explorer-col],[data-aionui-preview-col]) > * { background-color:var(--wp-bg-layer-2) !important; color:var(--wp-fg-primary); }',
      'html body[data-dsh-wallpaper-skin] :is([data-aionui-explorer-col],[data-aionui-preview-col]) :is(input,textarea) { background:var(--wp-bg-base) !important; color:var(--wp-fg-primary) !important; border-color:var(--wp-border-soft); }',
      'html body[data-dsh-wallpaper-skin] :is([data-aionui-explorer-col],[data-aionui-preview-col]) :is(input,textarea)::placeholder { color:var(--wp-fg-dimmed) !important; }',
      'html body[data-dsh-wallpaper-skin] :is([data-aionui-explorer-col],[data-aionui-preview-col]) :is(button,[role="button"]):focus-visible { outline:2px solid var(--wp-accent); outline-offset:2px; }',
      '@media (prefers-reduced-motion:reduce) { html body[data-dsh-wallpaper-skin] [data-composer-seat] > * { transition:none; } .wp-backdropBloom { animation:none !important; } }',
      'html body[data-dsh-wallpaper-skin] [data-pane="conversation"] :is(h1,h2,h3), html body[data-dsh-wallpaper-skin] [data-dsh-wallpaper-view] .wp-title { color: var(--wp-title-color,var(--dsw-alias-label-primary)); text-shadow: 0 3px 22px var(--wp-title-glow); }',
      ...
      'html body[data-dsh-wallpaper-skin] [role="dialog"], html body[data-dsh-wallpaper-skin] [role="menu"], html body[data-dsh-wallpaper-skin] .cm-editor, html body[data-dsh-wallpaper-skin] pre { background: var(--dsw-alias-bg-overlay) !important; }',
      '[data-dsh-wallpaper-view] { position: fixed; inset: 12px 12px 12px auto; display: block; z-index: 2147483000; box-sizing: border-box; width: min(760px, calc(100vw - 24px)); min-width: 0; max-width: calc(100vw - 24px) !important; overflow: hidden; border: 1px solid var(--dsw-alias-border-l2); border-radius: 14px; box-shadow: 0 18px 56px rgba(0,0,0,.42); }',
      '[data-dsh-wallpaper-view][hidden] { display: none !important; }',
      /* If a host shell constrains this fixed child below its readable width,
       * use the browser viewport rather than allowing a clipped right strip. */
      '[data-dsh-wallpaper-view][data-wp-force-fullscreen] { inset: 0 !important; width: 100vw !important; min-width: 100vw !important; max-width: 100vw !important; border-radius: 0; }',
      '[data-dsh-wallpaper-view][data-wp-force-fullscreen] [data-wp-drawer-handle] { display: none; }',
      '[data-wp-drawer-handle] { position: absolute; inset: 0 auto 0 0; z-index: 4; width: 28px; cursor: ew-resize; touch-action: none; outline: none; }',
      '[data-wp-drawer-handle]::after { content: ""; position: absolute; top: 18px; bottom: 18px; left: 12px; width: 3px; border-radius: 999px; background: var(--wp-border-soft); opacity: .72; transition: width 150ms ease, opacity 150ms ease, background-color 150ms ease; }',
      '[data-wp-drawer-handle]:hover::after, [data-wp-drawer-handle]:focus-visible::after, [data-dsh-wallpaper-view][data-wp-resizing] [data-wp-drawer-handle]::after { width: 5px; left: 11px; opacity: 1; background: var(--wp-accent); }',
      '[data-wp-drawer-handle]:focus-visible { box-shadow: inset 0 0 0 2px var(--wp-accent); }',
      'html body[data-dsh-wallpaper-skin] :is([data-pane="sidebar"],[data-pane="conversation"],[data-pane="details"],[data-aionui-explorer-col],[data-aionui-preview-col],[data-dsh-wallpaper-view], [data-dsh-wallpaper-view] *) { scrollbar-width: thin; scrollbar-color: var(--wp-border-strong) transparent; }',
      'html body[data-dsh-wallpaper-skin] :is([data-pane="sidebar"],[data-pane="conversation"],[data-pane="details"],[data-aionui-explorer-col],[data-aionui-preview-col],[data-dsh-wallpaper-view], [data-dsh-wallpaper-view] *)::-webkit-scrollbar { width: 10px; height: 10px; }',
      'html body[data-dsh-wallpaper-skin] :is([data-pane="sidebar"],[data-pane="conversation"],[data-pane="details"],[data-aionui-explorer-col],[data-aionui-preview-col],[data-dsh-wallpaper-view], [data-dsh-wallpaper-view] *)::-webkit-scrollbar-track { background: rgba(3,8,16,.22); }',
      'html body[data-dsh-wallpaper-skin] :is([data-pane="sidebar"],[data-pane="conversation"],[data-pane="details"],[data-aionui-explorer-col],[data-aionui-preview-col],[data-dsh-wallpaper-view], [data-dsh-wallpaper-view] *)::-webkit-scrollbar-thumb { min-height: 36px; border: 2px solid transparent; border-radius: 999px; background: var(--wp-border-strong); background-clip: padding-box; }',
      'html body[data-dsh-wallpaper-skin] :is([data-pane="sidebar"],[data-pane="conversation"],[data-pane="details"],[data-aionui-explorer-col],[data-aionui-preview-col],[data-dsh-wallpaper-view], [data-dsh-wallpaper-view] *)::-webkit-scrollbar-thumb:hover { background: var(--wp-accent); background-clip: padding-box; }',
      '/* --- sidebar entry --- */',
      ...
      '/* --- panel frame --- */',
      '.wp-panel { display: flex; flex-direction: column; box-sizing: border-box; width: 100%; height: 100%; min-width: 0; min-height: 0; padding: 14px 16px 16px; gap: 10px; overflow-x: hidden; background: var(--dsw-alias-bg-overlay); backdrop-filter: blur(var(--wp-blur,8px)) saturate(1.08); -webkit-backdrop-filter: blur(var(--wp-blur,8px)) saturate(1.08); color: var(--dsw-alias-label-primary); font-family: var(--dsw-font-family); }',
      '.wp-header { display: flex; align-items: center; gap: 10px; flex: none; flex-wrap: wrap; min-width: 0; }',
      '.wp-title { margin: 0; flex: 1 1 80px; min-width: 0; font-size: 16px; font-weight: 700; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }',
      '.wp-headerActions { display: flex; flex: 0 1 auto; align-items: center; justify-content: flex-end; gap: 8px; min-width: 0; flex-wrap: wrap; }',
      '.wp-headerActions .wp-tag { min-width: 0; overflow-wrap: anywhere; }',
      '.wp-toolbar { display: flex; align-items: flex-start; gap: 8px; flex: none; flex-wrap: wrap; min-width: 0; }',
      '.wp-toolbarFilters, .wp-toolbarActions { display: flex; align-items: center; gap: 8px; min-width: 0; flex-wrap: wrap; }',
      '.wp-toolbarFilters { flex: 1 1 250px; }',
      '.wp-toolbarActions { flex: 0 1 auto; }',
      '.wp-search { flex: 1 1 160px; min-width: 0; padding: 6px 10px; font-size: 13px; color: var(--dsw-alias-label-primary); background: var(--dsw-specific-input-major); border: 1px solid var(--dsw-alias-border-l2); border-radius: 8px; outline: none; }',
      ...
      '.wp-btn { max-width: 100%; padding: 5px 12px; font-size: 12px; color: var(--dsw-alias-label-primary); background: transparent; border: 1px solid var(--dsw-alias-border-l2); border-radius: 8px; cursor: pointer; white-space: nowrap; }',
      '.wp-btn:hover:not(:disabled) { background: var(--dsw-alias-interactive-bg-hover); }',
      '.wp-btn:disabled { opacity: 0.5; cursor: default; }',
      '.wp-btn-primary { color: var(--wp-fg-primary,#fff) !important; background: var(--wp-action-fill,var(--wp-accent-secondary,var(--wp-accent,#4f8cff))) !important; border-color: var(--wp-action-fill,var(--wp-accent-secondary,var(--wp-accent,#4f8cff))) !important; font-weight: 600; }',
      '.wp-btn-primary:hover:not(:disabled) { background: var(--wp-action-hover,var(--wp-accent-secondary-hover,var(--wp-accent-hover,#3e75d0))) !important; }',
      '.wp-spacer { flex: 1; }',
      ...
      '.wp-scrim { display: grid; grid-template-columns: max-content minmax(0,1fr) max-content; align-items: center; gap: 8px; min-width: 0; flex: none; font-size: 12px; color: var(--dsw-alias-label-secondary); }',
      '.wp-scrim input[type=range] { min-width: 0; width: 100%; accent-color: var(--dsw-alias-state-business-primary); }',
      '.wp-scrim .wp-btn { grid-column: 1 / -1; justify-self: start; }',
      ...
      '.wp-settingsGrid { display: grid; grid-template-columns: repeat(auto-fit,minmax(min(340px,100%),1fr)); gap: 10px 18px; padding: 0 12px 12px; }',
      '.wp-setting { display: grid; grid-template-columns: minmax(96px,max-content) minmax(0,1fr) max-content; align-items: center; gap: 8px; min-width: 0; font-size: 12px; color: var(--dsw-alias-label-secondary); }',
      '.wp-setting > span:first-child { min-width: 0; color: var(--dsw-alias-label-primary); font-weight: 600; white-space: nowrap; }',
      '.wp-setting > span:nth-child(2) { min-width: 0; line-height: 1.4; overflow-wrap: anywhere; }',
      '.wp-setting--flow { grid-column: 1 / -1; }',
      '.wp-setting--flow .wp-settingCopy { color: var(--dsw-alias-label-secondary); }',
      '.wp-setting--flow .wp-btn { grid-column: 1 / -1; justify-self: start; }',
      ...
      '@media (max-width: 560px) { .wp-headerActions { width: 100%; justify-content: space-between; } .wp-toolbarFilters, .wp-toolbarActions { width: 100%; } .wp-toolbarActions { justify-content: flex-start; } .wp-toolbarActions .wp-btn { flex: 1 1 120px; min-height: 34px; } .wp-scrim { grid-template-columns: max-content minmax(0,1fr) max-content; } .wp-setting { grid-template-columns: 1fr max-content; align-items: start; } .wp-setting > span:first-child { grid-column: 1 / -1; } .wp-setting > span:nth-child(2) { grid-column: 1; } .wp-setting > :is(input[type=range],select) { grid-column: 1 / -1; width: 100%; } .wp-setting input[type=color] { grid-column: 1 / -1; grid-row: auto; justify-self: start; } .wp-setting--flow .wp-settingCopy { grid-column: 1 / -1; } }',
      '[data-dsh-wallpaper-view][data-wp-compact] .wp-headerActions { width: 100%; justify-content: space-between; }',
      '[data-dsh-wallpaper-view][data-wp-compact] .wp-headerActions .wp-tag { flex: 1 1 160px; }',
      '[data-dsh-wallpaper-view][data-wp-compact] .wp-toolbarFilters, [data-dsh-wallpaper-view][data-wp-compact] .wp-toolbarActions { width: 100%; }',
      '[data-dsh-wallpaper-view][data-wp-compact] .wp-toolbarActions { justify-content: flex-start; }',
      '[data-dsh-wallpaper-view][data-wp-compact] .wp-toolbarActions .wp-btn { flex: 1 1 120px; min-height: 34px; }',
      '[data-dsh-wallpaper-view][data-wp-compact] .wp-setting { grid-template-columns: 1fr max-content; align-items: start; }',
      '[data-dsh-wallpaper-view][data-wp-compact] .wp-setting > span:first-child { grid-column: 1 / -1; }',
      '[data-dsh-wallpaper-view][data-wp-compact] .wp-setting > span:nth-child(2) { grid-column: 1; }',
      '[data-dsh-wallpaper-view][data-wp-compact] .wp-setting > :is(input[type=range],select) { grid-column: 1 / -1; width: 100%; }',
      '[data-dsh-wallpaper-view][data-wp-compact] .wp-setting input[type=color] { grid-column: 1 / -1; grid-row: auto; justify-self: start; }',
      '[data-dsh-wallpaper-view][data-wp-compact] .wp-setting--flow .wp-settingCopy { grid-column: 1 / -1; }',
      '@media (max-width: 760px) { [data-dsh-wallpaper-view] { inset: 0; width: 100vw !important; border-radius: 0; } [data-wp-drawer-handle] { display:none; } .wp-panel { padding: 10px; } .wp-spacer { display: none; } .wp-grid { grid-template-columns: repeat(auto-fill, minmax(min(190px, 100%), 1fr)); } .wp-local { align-items: stretch; } .wp-local .wp-path { flex: 1 1 100%; } .wp-settingsGrid { grid-template-columns: 1fr; padding-inline: 10px; } }',
    ...
    var API = {
      ...
      libraryWatch: '/api/dsh-wallpaper/library-watch',
    ...
    function applyWallpaperPalette(color) {
      ...
      // Wallpaper mode is intentionally dark glass. Sampling the host light
      // theme produced dark text on translucent bright art, which failed the
      // most basic reading requirement in real conversations.
      var dark = true
      var surface = mixRgb(themeColor, [7, 13, 22], 0.76)
      var accent = mixRgb(themeColor, [228, 240, 255], 0.20)
      accent = ensureContrast(accent, surface, 4.5, [255, 255, 255])
      var accentHover = mixRgb(accent, [255, 255, 255], 0.14)
      var secondarySource = manualSecondary || presetSecondary || rotateHue(themeColor, 42)
      var secondary = mixRgb(secondarySource, [236, 244, 255], 0.22)
      secondary = ensureContrast(secondary, surface, 4.5, [255, 255, 255])
      var secondaryHover = mixRgb(secondary, [255, 255, 255], 0.14)
      var foregroundPrimary = [248, 250, 255]
      var foregroundSecondary = [222, 230, 238]
      var foregroundTertiary = [190, 204, 218]
      var foregroundDimmed = [157, 174, 191]
      // A colour can be readable over a dark panel yet still be too light for
      // the white text inside a primary button. Calculate that fill separately.
      var actionFill = ensureContrast(secondary, foregroundPrimary, 4.5, surface)
      var actionHover = ensureContrast(mixRgb(actionFill, [255, 255, 255], 0.08), foregroundPrimary, 4.5, surface)
      ...
      style.setProperty('--wp-bg-base', rgba(surface, Math.max(0.10, panelOpacity * 0.34)))
      style.setProperty('--wp-bg-layer-1', rgba(surface, Math.max(0.22, panelOpacity * 0.72)))
      style.setProperty('--wp-bg-layer-2', rgba(surface, Math.max(0.30, panelOpacity * 0.88)))
      style.setProperty('--wp-bg-layer-3', rgba(surface, Math.min(0.90, panelOpacity + 0.14)))
      style.setProperty('--wp-sidebar', rgba(surface, Math.max(0.38, panelOpacity * 0.88)))
      style.setProperty('--wp-home-surface', rgba(surface, Math.max(0.12, panelOpacity * 0.54)))
      ...
      style.setProperty('--wp-action-fill', 'rgb(' + actionFill.join(',') + ')')
      style.setProperty('--wp-action-hover', 'rgb(' + actionHover.join(',') + ')')
      ...
      style.setProperty('--wp-bloom-primary', rgba(accent, 0.34))
      style.setProperty('--wp-bloom-secondary', rgba(secondary, 0.27))
      style.setProperty('--wp-title-glow', rgba(accent, 0.38))
      style.setProperty('--wp-composer-glow', rgba(accent, 0.14))
      style.setProperty('--wp-composer-glow-strong', rgba(secondary, 0.26))
    ...
    function markAdaptiveSurfaces() {
      var roots = document.querySelectorAll('[data-pane], [data-composer-seat], [data-shell-overlay], main, aside, [role="main"], [role="complementary"]')
      for (var i = 0; i < roots.length; i++) {
        var candidates = [roots[i]].concat(Array.from(roots[i].querySelectorAll('*')))
        for (var j = 0; j < candidates.length; j++) {
          var node = candidates[j]
          if (!(node instanceof HTMLElement)) continue
          // AionUI panels carry their own semantic colour tokens below. Do
          // not flatten their file-tree/tab states into one generic surface.
          if (node.closest('[data-aionui-explorer-col], [data-aionui-preview-col]')) continue
    ...
    function clearGifLoop(keepDescriptor) {
      ...
      if (skinRuntime.gifRevealTimer !== undefined) window.clearTimeout(skinRuntime.gifRevealTimer)
      skinRuntime.gifTimer = undefined
      skinRuntime.gifRestartTimer = undefined
      skinRuntime.gifRevealTimer = undefined
    ...
    function resolveBackdropFit(skin, harness) {
      ...
      // The default is deliberately full-bleed. The user can select contain
      // when preserving every edge matters; only a known low-resolution Scene
      // preview uses ambient protection to avoid magnifying a tiny GIF.
      return harness && harness.fit === 'ambient' ? 'ambient' : 'cover'
    }
    ...
    function applyBackdropFit(skin, harness, ambientUrl) {
      ...
      applyDetailEnhancement(harness)
      return fit
    }

    function applyDetailEnhancement(harness) {
      var layer = skinRuntime.layer
      if (layer === undefined) return
      var width = Number(harness && harness.previewWidth)
      var height = Number(harness && harness.previewHeight)
      var lowQuality = harness && (harness.quality === 'low' || harness.fit === 'ambient')
      if (!lowQuality || !Number.isFinite(width) || !Number.isFinite(height) || width < 1 || height < 1) {
        layer.style.removeProperty('--wp-detail-contrast')
        layer.style.removeProperty('--wp-detail-saturation')
        delete layer.dataset.wpDetail
        return
      }
      var viewportWidth = Math.max(1, window.innerWidth || (document.documentElement && document.documentElement.clientWidth) || 1)
      var viewportHeight = Math.max(1, window.innerHeight || (document.documentElement && document.documentElement.clientHeight) || 1)
      var upscale = Math.max(1, Math.min(viewportWidth / width, viewportHeight / height))
      var shortSide = Math.min(width, height)
      var strong = shortSide <= 256 || upscale >= 3
      var medium = !strong && (shortSide <= 480 || upscale >= 1.8)
      layer.dataset.wpDetail = strong ? 'strong' : (medium ? 'medium' : 'light')
      layer.style.setProperty('--wp-detail-contrast', strong ? '1.09' : (medium ? '1.065' : '1.04'))
      layer.style.setProperty('--wp-detail-saturation', strong ? '1.07' : (medium ? '1.05' : '1.03'))
    }
    ...
    function showImage(url, harness, canonicalUrl) {
      ...
      var reduceMotion = (skinRuntime.motion !== undefined && skinRuntime.motion.matches) || (skinRuntime.skin && skinRuntime.skin.motionMode === 'static')
      var restartingGif = animatedGif && typeof canonicalUrl === 'string' && canonicalUrl !== '' && canonicalUrl !== url
      var retainedGifStill = restartingGif && skinRuntime.still !== undefined
        && skinRuntime.still.dataset.wpHidden === undefined
        && skinRuntime.still.complete && skinRuntime.still.naturalWidth > 0
      // Do not use display:none while a GIF is starting: Chromium can defer
      // its decode until the element becomes visible, exposing a black/white
      // first frame. Keep the prior captured still above the change until the
      // new animation has had a short, invisible settling interval.
      var next = el('img', { alt: '', dataset: { wpPrimary: '', wpLoading: '' } })
      ...
      next.addEventListener('load', function () {
        ...
        if (retainedGifStill) {
          // During a restart the previous near-tail snapshot is already known
          // to be safe. Do not overwrite it with the newly decoded first GIF
          // frame: many Wallpaper Engine previews use a black reset frame.
          // Keep the safe still visible while the replacement advances.
          skinRuntime.gifRevealTimer = window.setTimeout(revealGif, 180)
          return
        }
        captureGifStill(next, generation, function (captured) {
          ...
          // A retained still has already been captured. Let the GIF advance
          // off-screen before it is revealed, which removes first-frame
          // flashes from short Wallpaper Engine preview GIFs.
          skinRuntime.gifRevealTimer = window.setTimeout(revealGif, 140)
        })
      })
    ...
    function renderBackdrop(skin) {
      ...
      layer.hidden = false
      layer.dataset.wpMotion = skin.motionMode === 'static' ? 'static' : 'play'
      ...
      var reduceMotion = (skinRuntime.motion !== undefined && skinRuntime.motion.matches) || skin.motionMode === 'static'
    ...
    function mountBackdrop() {
      ...
      var primaryBloom = el('div', { class: 'wp-backdropBloom', dataset: { wpBloom: 'primary' } })
      var secondaryBloom = el('div', { class: 'wp-backdropBloom', dataset: { wpBloom: 'secondary' } })
      var scrim = el('div', { class: 'wp-backdropScrim' })
      layer.append(ambient, still, image, video, primaryBloom, secondaryBloom, scrim)
    ...
    function loadList(state) {
      ...
      state.listRequest = fetch(API.list, { cache: 'no-store' })
        ...
        .then(function (body) {
          ...
          if (Number.isSafeInteger(body.revision)) state.libraryRevision = body.revision
    ...
    function syncPanelSkin(state, skin) {
      ...
      state.motionModeValue = skin && skin.motionMode === 'static' ? 'static' : 'play'
      ...
      if (state.motionModeInput) state.motionModeInput.value = state.motionModeValue
    ...
    function mountPanelView(controller) {
      var state = {
        ...
        motionModeValue: skinRuntime.skin && skinRuntime.skin.motionMode === 'static' ? 'static' : 'play',
      ...
      function buildPanel() {
        ...
        state.title = title
        var headerActions = el('div', { class: 'wp-headerActions' }, [statusBadge, closePanel])
        ...
        var toolbarFilters = el('div', { class: 'wp-toolbarFilters' }, [search, typeSelect])
        var toolbarActions = el('div', { class: 'wp-toolbarActions' }, [count, refresh, randomHarness, randomDesktop])
        ...
        var motionModeInput = el('select', { class: 'wp-select', 'aria-label': '动态背景播放方式' }, [
          el('option', { value: 'play' }, ['播放动图 / 视频']),
          el('option', { value: 'static' }, ['静态预览（停止播放）']),
        ])
        motionModeInput.value = state.motionModeValue
        ...
        state.motionModeInput = motionModeInput
        ...
        var appearance = el('details', { class: 'wp-appearance', open: '' }, [
          ...
          el('div', { class: 'wp-settingsGrid' }, [
            ...
            el('label', { class: 'wp-setting' }, [el('span', {}, ['动态背景']), motionModeInput]),
            ...
            el('div', { class: 'wp-setting wp-setting--flow' }, [el('span', {}, ['自动流程']), el('span', { class: 'wp-settingCopy' }, ['壁纸取色 → 面板 / 边框 / 标题 / 按钮']), resetAppearance]),
          ]),
        ])
        ...
        motionModeInput.addEventListener('change', function () {
          state.motionModeValue = motionModeInput.value === 'static' ? 'static' : 'play'
          postSkin({ action: 'apply', motionMode: state.motionModeValue })
            .then(function (skin) {
              syncPanelSkin(state, skin)
              renderBackdrop(skin)
              setBanner(state, 'ok', state.motionModeValue === 'static' ? '动态背景已停止，正在显示静态预览' : '动态背景播放已恢复')
            })
            .catch(function (error) { setBanner(state, 'error', error.message) })
        })
        ...
        resetAppearance.addEventListener('click', function () {
          postSkin({ action: 'apply', scrim: 0.35, panelOpacity: 0.52, inputOpacity: 0.84, blur: 8, brightness: 1, backgroundFit: 'auto', motionMode: 'play', presetId: null, paletteMode: 'auto', accentColor: '#4f8cff', secondaryAccentColor: '#62c7a5' })
      ...
      var libraryTimer
      var libraryWatchController
      var libraryWatchTimer
      var resizeCleanup
      var drawerLayoutObserver
      var drawerWidth
      var drawerFullscreenFallback = false
      var DRAWER_WIDTH_KEY = 'dsh-wallpaper.drawer-width.v1'

      function availableViewportWidth() {
        var candidates = [window.innerWidth, document.documentElement && document.documentElement.clientWidth, window.visualViewport && window.visualViewport.width]
          .filter(function (width) { return typeof width === 'number' && Number.isFinite(width) && width > 0 })
        return candidates.length > 0 ? Math.floor(Math.min.apply(Math, candidates)) : 0
      }

      function drawerLimits() {
        var maximum = Math.max(0, Math.min(1040, availableViewportWidth() - 24))
        return { min: Math.min(420, maximum), max: maximum }
      }

      function syncDrawerDensity() {
        if (container === undefined) return
        var measured = container.getBoundingClientRect().width
        var width = Number.isFinite(measured) && measured > 0
          ? measured
          : (availableViewportWidth() <= 760 ? availableViewportWidth() : drawerWidth)
        if (Number.isFinite(width) && width <= 620) container.dataset.wpCompact = ''
        else delete container.dataset.wpCompact
        // `fixed` descendants can still be clipped by an embedding shell with
        // a transform/contain boundary. Once it is this narrow, retain the
        // full-screen escape hatch until the panel is closed and opened again.
        if (Number.isFinite(measured) && measured > 0 && measured < 360) {
          drawerFullscreenFallback = true
          container.dataset.wpForceFullscreen = ''
        } else if (!drawerFullscreenFallback) {
          delete container.dataset.wpForceFullscreen
        }
      }

      function setDrawerWidth(value, persist) {
        if (container === undefined || availableViewportWidth() <= 760 || drawerFullscreenFallback) {
          if (container !== undefined) container.style.removeProperty('width')
          syncDrawerDensity()
          return
        }
        var limits = drawerLimits()
        drawerWidth = Math.round(Math.max(limits.min, Math.min(limits.max, Number(value) || 760)))
        container.style.width = drawerWidth + 'px'
        syncDrawerDensity()
        var handle = container.querySelector('[data-wp-drawer-handle]')
        if (handle instanceof HTMLElement) {
          handle.setAttribute('aria-valuemin', String(limits.min))
          handle.setAttribute('aria-valuemax', String(limits.max))
          handle.setAttribute('aria-valuenow', String(drawerWidth))
          handle.setAttribute('aria-valuetext', drawerWidth + ' 像素')
        }
        if (persist) {
          try { localStorage.setItem(DRAWER_WIDTH_KEY, String(drawerWidth)) } catch { /* storage is optional */ }
        }
      }
      ...
      function bindDrawerResize(handle) {
        ...
        function stopDrag() {
          ...
          drag = undefined
          if (container !== undefined) delete container.dataset.wpResizing
        ...
        function onPointerMove(event) {
          ...
          setDrawerWidth(drag.startWidth + drag.startX - event.clientX, false)
        }
        function onPointerDown(event) {
          if (event.button !== 0 || availableViewportWidth() <= 760 || drawerFullscreenFallback) return
          event.preventDefault()
          var width = container ? container.getBoundingClientRect().width : 760
          drag = { pointerId: event.pointerId, startX: event.clientX, startWidth: width }
          if (container !== undefined) container.dataset.wpResizing = ''
          try { handle.setPointerCapture(event.pointerId) } catch { /* window listeners are the fallback */ }
          window.addEventListener('pointermove', onPointerMove)
          window.addEventListener('pointerup', stopDrag)
          window.addEventListener('pointercancel', stopDrag)
        }
        function onKeydown(event) {
          if (availableViewportWidth() <= 760 || drawerFullscreenFallback) return
          var limits = drawerLimits()
          var current = drawerWidth || (container ? container.getBoundingClientRect().width : limits.min)
          var next
        ...
        function onResize() { setDrawerWidth(drawerWidth || 760, false) }
      ...
      function startLibrarySync() {
        if (libraryTimer === undefined) libraryTimer = window.setInterval(syncLibrary, 5000)
        if (libraryWatchController === undefined && libraryWatchTimer === undefined) watchLibrary()
      }

      function watchLibrary() {
        if (!controller.getSnapshot().panelOpen || document.hidden || libraryWatchController !== undefined) return
        var watchController = new AbortController()
        libraryWatchController = watchController
        var signal = watchController.signal
        var revision = Number.isSafeInteger(state.libraryRevision) ? state.libraryRevision : 0
        fetch(API.libraryWatch + query({ revision: revision, timeout: 25000 }), { cache: 'no-store', signal: signal })
          .then(function (response) { return readJson(response) })
          .then(function (body) {
            // A close/reopen can start a newer request while this older one
            // is unwinding. Only the request that still owns the slot may
            // clear it or schedule the next poll.
            if (libraryWatchController !== watchController) return
            libraryWatchController = undefined
            if (body && Number.isSafeInteger(body.revision) && body.revision !== state.libraryRevision) syncLibrary()
            if (controller.getSnapshot().panelOpen && !document.hidden) watchLibrary()
          })
          .catch(function () {
            if (libraryWatchController !== watchController) return
            libraryWatchController = undefined
            // Some network drives do not support native directory watches.
            // Keep the five-second list poll and retry the notification route
            // later without surfacing a non-critical warning to the user.
            if (controller.getSnapshot().panelOpen && !document.hidden) {
              libraryWatchTimer = window.setTimeout(function () {
                libraryWatchTimer = undefined
                watchLibrary()
              }, 2000)
            }
          })
      ...
      function stopLibrarySync() {
        ...
        if (libraryWatchTimer !== undefined) window.clearTimeout(libraryWatchTimer)
        libraryWatchTimer = undefined
        if (libraryWatchController !== undefined) libraryWatchController.abort()
        libraryWatchController = undefined
      }
      ...
      function ensure() {
        ...
        var handle = el('div', {
          dataset: { wpDrawerHandle: '' },
          role: 'separator',
          tabindex: '0',
          'aria-label': '拖动以调整壁纸抽屉宽度',
          'aria-orientation': 'vertical',
          title: '拖动调整宽度；键盘左右方向键可微调',
        })
        container.appendChild(handle)
        container.appendChild(panel !== undefined ? panel : (panel = buildPanel()))
        try {
          var storedWidth = Number(localStorage.getItem(DRAWER_WIDTH_KEY))
          drawerWidth = Number.isFinite(storedWidth) && storedWidth > 0 ? storedWidth : 760
        } catch { drawerWidth = 760 }
        setDrawerWidth(drawerWidth, false)
        if (resizeCleanup !== undefined) resizeCleanup()
        resizeCleanup = bindDrawerResize(handle)
        ...
        if (typeof ResizeObserver === 'function') {
          if (drawerLayoutObserver !== undefined) drawerLayoutObserver.disconnect()
          drawerLayoutObserver = new ResizeObserver(function () { syncDrawerDensity() })
          drawerLayoutObserver.observe(container)
        }
      ...
      function applyActive() {
        if (controller.getSnapshot().panelOpen) {
          ...
          if (container !== undefined) {
            // A panel that was forced full-screen may have been closed after
            // the host layout recovered. Try the remembered desktop width on
            // reopen; ResizeObserver will safely force it again if needed.
            if (drawerFullscreenFallback) {
              drawerFullscreenFallback = false
              delete container.dataset.wpForceFullscreen
              setDrawerWidth(drawerWidth || 760, false)
            }
      ...
      return function () {
        ...
        if (drawerLayoutObserver !== undefined) drawerLayoutObserver.disconnect()
        drawerLayoutObserver = undefined
        document.documentElement.removeAttribute(ACTIVE_ATTR)
